...
/* Capability/config getters, used by dtt_callbacks.c's VMInit handler
 * to decide whether/how to start the live bytecode watchdog (see
 * dtt_watchdog.h). Set once during dtt_agent_init(), read-only after. */
