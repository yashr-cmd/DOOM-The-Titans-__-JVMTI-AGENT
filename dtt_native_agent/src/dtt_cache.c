/* ============================================================================
 * dtt_cache.c - see dtt_cache.h for design notes.
 * ============================================================================ */
...
/* Linear search is intentional: DTT_CACHE_CAPACITY is small (hundreds
 * of entries at most, one per protected .class file) and this runs on
 * the relatively rare path of class (re)loading, not per-tick game
 * logic - simplicity and obvious correctness win over a hash table
 * here. Caller must hold g_cache_mutex. */
